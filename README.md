...
Download and unzip [Apache Spark 3.0.0+](https://spark.apache.org) to a location of your choice.

```bash
curl -L "https://archive.apache.org/dist/spark/spark-3.0.0-preview/spark-3.0.0-preview-bin-hadoop2.7.tgz" > spark-2.4.4-bin-hadoop2.7.tgz
